...
namespace Entidades
{
    public class GenericList<T> : IArchivos<GenericList<T>> where T : Contaminante
    {
        ...
        /// Devuelve en el parametro out coincidencias la sumatoria de las cantidades de fabricas/vehiulos que coinciden con la provincia seleccionada.
        /// </summary>
        /// <param name="provincia"></param>
        /// <returns>float los gases de efecto invernadero emitidos por la provinica pasada como parametro</returns>
        public float ContaminacionEnLaProvincia(EProvincias provincia, out int coincidencias)
        {
            coincidencias = 0;
            float resultado = 0;
        ...
        /// Devuelve en el parametro out coincidencias la sumatoria de las cantidades de fabricas/vehiulos que coinciden con el tipo seleccionado.
        /// </summary>
        /// <param name="tipo"></param>
        /// <returns>float los gases totales emitidos por el tipo seleccionado</returns>
        public float ContaminacionPorTipo(int tipo, out int coincidencias)
        {
            float resultado = 0;
            coincidencias = 0;
            foreach (T item in this.elementos)
            {
                resultado += item.ObtenerGasesEnElTipo(tipo, out int coincide);
